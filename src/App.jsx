      ...
      <div className='main'>
        ...
        <div className="body-container">
          ...
          <section>
            ...
            <article>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVTU89MIWSq3LP_chJmHwSTWGLHolHRbkPXw&s" alt="slug" />
            <div className="project-info">
             ...
             <Button icon={<LikeOutlined />}>Soutenir mon projet</Button>            
            </div> 
            </article>
            </section>
          </div>
